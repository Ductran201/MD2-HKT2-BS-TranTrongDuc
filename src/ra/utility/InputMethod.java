...
public class InputMethod {
    private static final String ERROR_ALERT = "===>> Wrong format input, please try again";
    private static final String EMPTY_ALERT = "===>> This filed must not blank! please try again";
    /*========================================Input Method Start========================================*/
